...
#   0 */6 * * * bash /tmp/continuum-mobile/integrations/email-bridge/auto-trash-junk.sh >> ~/.continuum-auto-trash.log 2>&1
set -euo pipefail
...
node "${REPO}/integrations/email-bridge/auto-trash-junk.js"
