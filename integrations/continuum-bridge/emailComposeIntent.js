...
/**
 * User wants to draft or send an email to someone — not fetch/clean their inbox.
 * e.g. "Draft Min an email canceling Sunday dinner"
 */
function isComposeEmailRequest(message) {
