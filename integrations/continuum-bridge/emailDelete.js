...
const CLEANUP_MARKETING_SENDERS = /\b(auction\.com|adc\.auction|realtytrac|foreclosurefortunes|foreclosure|shopifyemail\.com|@t\.shopifyemail|hit-reply@linkedin|mailer\.appfolio|appfolio\.us|mattressfirm|mattress\s+firm|@welcome\.americanexpress|@infos-|notifications@united\.com|bostonsailingcenter)\b/i;
