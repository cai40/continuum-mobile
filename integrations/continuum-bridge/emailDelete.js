...
const CLEANUP_MARKETING_SENDERS = /\b(auction\.com|adc\.auction|realtytrac|foreclosurefortunes|foreclosure|shopifyemail\.com|@t\.shopifyemail|hit-reply@linkedin|mailer\.appfolio|appfolio\.us|mattressfirm|mattress\s+firm|@welcome\.americanexpress|@infos-|notifications@united\.com|bostonsailingcenter|auto-reply@usps\.com|@email\.usps\.gov|informeddelivery\.usps)\b/i;
const CLEANUP_RECEIPT_KEEP = /\b(receipt|invoice|order confirm(?:ation)?|confirmation number|your order|shipped|delivery confirm|payment received|tracking number|out for delivery|has shipped|pickup ready|paid you|sent you \$|flight confirm(?:ation)?|itinerar|check.?in|boarding pass|e-?ticket|trip confirm(?:ation)?)\b/i;
